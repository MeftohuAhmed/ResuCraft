...
/**
 * ExperienceForm component renders a form for capturing work experience details.
 *
 * @param {object} props - The props passed to this component.
 * @param {number} props.index - The index of the experience in the form.
 * @param {object} props.formik - Formik object for form state and functions.
 */
const ExperienceForm = ({ index, formik }) => {
    // Extract values and errors for better readability
        ...
        <>
            <Grid container spacing={4}>
                ...
                <Grid item xs={6} className="item">
                    ...
                    {/* Autocomplete and TextField for Country selection */}
                    {formik && (
                        <Autocomplete
                ...
                <Grid item xs={12} className="item">
                    ...
                    {descriptionError && descriptionTouch && <p className="error-text">{descriptionError}</p>}
                </Grid>
            </Grid>
        </>
    );
