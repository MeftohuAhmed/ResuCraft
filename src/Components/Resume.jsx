...
/**
 * Resume component displays a resume template with user information, work experience, education, and customization options.
 */
const Resume = () => {
    // Constants and templates for customization
    ...
    // Function to generate PDF from the template
    ...
    // Function to generate PNG image from the template
    ...
    // Function to format date from UTC to a readable format
            ...
            >
                ...
                <div className="dropdown">
                    ...
                    <div className="dropdown-content">
                        <a
                            href="#"
                            // Call handleGeneratePdf function to download as PDF
                        ...
                        <a
                            href="#"
                            // Call handleGeneratePng function to download as PNG
